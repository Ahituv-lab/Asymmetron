...
cat gencode.v33.annotation.bed.protein_coding | awk '$6=="+" {print $0}' > gencode.v33.annotation.bed.genes_protein_coding.formatted.plus
cat gencode.v33.annotation.bed.protein_coding | awk '$6=="-" {print $0}' > gencode.v33.annotation.bed.genes_protein_coding.formatted.minus
...
cat LINEs.bed  | awk '$8=="L1" {print $0}'
cat LINEs.bed  | awk '$8=="L2" {print $0}'
cat SINEs.bed  | awk '$8=="Alu" {print $0}'
cat SINEs.bed  | awk '$8=="MIR" {print $0}'
