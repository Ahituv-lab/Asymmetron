...
def fun2(args):
    ...
    p_val_same_oppositeL=[];p_val_same_opposite_BonferoniL=[];Ratio_same_oppositeL=[];p_val_conv_divergL=[];p_val_conv_diver_BonferoniL=[];Ratio_conv_divergL=[];
    ...
    for i in range(len(motif_region_pairs)): 
        ...
        p_pL.apend(p_p);m_mL.append(m_m); # Same strand orientation
        p_mL.append(p_m);m_pL.append(m_pL); # Opposite strand orientation
