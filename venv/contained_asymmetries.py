	...
	# Save the results for the final table
        ...
        for i in range(len(motif_region_pairs)):
            ...
            if score:
                ...
                functions.table_bins_gen(names_pairs,Score_names,Ratio_Bins,Ratio_Convergent_Divergent_Bins,wf.output_path("contained_asymmetries","txt", "Table_Strand_Asymmetries_Scores", names_pairs[i][0],names_pairs[i][1]))
