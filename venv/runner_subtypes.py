...
p_p, m_m, p_m, m_p, same_strand, opposite_strand, convergent, divergent = functions.overlap(read_BED("/nfs/compgen-04/team218/ilias/strand_program/gnomad/subtypes/Alu_hg38.txt"),read_BED("/nfs/compgen-04/team218/ilias/strand_program/TFBSs/gencode.v33.annotation.bed"))
template_LINEs=((p_p+m_m)/float(p_p+m_m+p_m+m_p))

p_p, m_m, p_m, m_p, same_strand, opposite_strand, convergent, divergent = functions.overlap(read_BED("/nfs/compgen-04/team218/ilias/strand_program/gnomad/subtypes/L1_hg38.txt"),read_BED("/nfs/compgen-04/team218/ilias/strand_program/TFBSs/gencode.v33.annotation.bed"))
...
for cancer_tissue in tissuesD.keys():
	...
	for cancer in tissuesD[cancer_tissue]:
		...
		for one in files:
			...
			print(one,cancer)
			try:
                                Annotation_data_LINEs=functions.strand_annotate_third_BED_overlap(one,read_BED("/nfs/compgen-04/team218/ilias/strand_program/gnomad/subtypes/Alu_hg38.txt"))
			...
			try:
                	        Annotation_data_SINEs=functions.strand_annotate_third_BED_overlap(one,read_BED("/nfs/compgen-04/team218/ilias/strand_program/gnomad/subtypes/L1_hg38.txt"))
...
plt.savefig("Cancers_Strand_Asymmetries_Alu_L1.png")
plt.close()
